...
# By doing this, only the past commands matching the current line up to the current
...
# File manager keybindings, Alt+Left goes back in hystory, Alt+Up goes to parent dir
cdUndoKey() {
  popd
  zle       reset-prompt
  print
