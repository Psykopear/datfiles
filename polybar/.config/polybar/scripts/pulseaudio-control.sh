...
VOLUME_ICONS=("▰▰▰▰▰▰▰▰▰▰" "%{F#1E88E5}▰%{F#FFFFFF}▰▰▰▰▰▰▰▰▰" "%{F#1E88E5}▰▰%{F#FFFFFF}▰▰▰▰▰▰▰▰" "%{F#1E88E5}▰▰▰%{F#FFFFFF}▰▰▰▰▰▰▰" "%{F#1E88E5}▰▰▰▰%{F#FFFFFF}▰▰▰▰▰▰" "%{F#1E88E5}▰▰▰▰▰%{F#FFFFFF}▰▰▰▰▰" "%{F#1E88E5}▰▰▰▰▰▰%{F#FFFFFF}▰▰▰▰" "%{F#1E88E5}▰▰▰▰▰▰▰%{F#FFFFFF}▰▰▰" "%{F#1E88E5}▰▰▰▰▰▰▰▰%{F#FFFFFF}▰▰" "%{F#1E88E5}▰▰▰▰▰▰▰▰▰%{F#FFFFFF}▰" "%{F#1E88E5}▰▰▰▰▰▰▰▰▰▰")
...
function output() {
    ...
    if [ "${isMuted}" = "yes" ]; then
        echo "${MUTED_COLOR}${MUTED_ICON}${endColor}"
    else
        echo "%{T2}${volIcon}"
    fi
}
